...
async function refresh() {
  ...
  document.getElementById('pendingList').innerHTML =
    ...
    + `<li class="browse-item"><button class="browse-btn" id="browseBtn">Add Videos<span class="browse-btn-icon">&#xf09b3;</span></button><span class="browse-hint-group"><span class="hint-icon">?</span><span class="hint-wrapper"><span class="hint-letters">${hintLettersHtml}</span><span class="hint-cursor cursor-blink">_</span></span></span></li>`;
